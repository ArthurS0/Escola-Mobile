...
function Atividades() {
    ...
    return (<>
<header className="w-full bg-red-700 text-white flex flex-row items-center justify-between p-4 shadow-lg">
    <h1 className="font-bold text-lg">{professor.nome}</h1>
    <Button variant="destructive" className="bg-red-600 hover:bg-red-800 text-white py-2 px-4 rounded-lg" onClick={() => sair()}>Sair</Button>
</header>
        ...
        <main className="min-h-screen flex items-center justify-center p-6 bg-gray-50">
            <div className="w-full max-w-3xl space-y-6 flex flex-col">
                <div className="w-full flex justify-end">
                    <Dialog open={open} onOpenChange={setOpen}>
                        <DialogTrigger asChild>
                            <Button className="bg-red-500 text-white hover:bg-red-600 py-2 px-4 rounded-lg">Cadastrar atividade</Button>
                        </DialogTrigger>
                        <DialogContent className="sm:max-w-[425px] bg-white shadow-xl rounded-lg p-6">
                            ...
                            <form onSubmit={(e) => {
                                ...
                                />
                                <DialogFooter>
                                    <Button type="submit" disabled={submitting || !descricao.trim()} className="bg-red-500 text-white hover:bg-red-600 py-2 px-4 rounded-lg">
                ...
                <h2 className="text-xl font-semibold text-gray-800">Turma: <span className="text-red-600">{turma}</span></h2>
